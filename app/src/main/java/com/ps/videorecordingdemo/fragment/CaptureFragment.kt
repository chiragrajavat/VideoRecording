...
import com.ps.videorecordingdemo.adapter.GenericListAdapter
import com.ps.videorecordingdemo.databinding.FragmentCaptureBinding
import com.ps.videorecordingdemo.extentions.getAspectRatio
import com.ps.videorecordingdemo.extentions.getAspectRatioString
import com.ps.videorecordingdemo.extentions.getNameString
    ...
    private fun updateUI(event: VideoRecordEvent) {
        ...
        when (event) {
            ...
            is VideoRecordEvent.Pause -> {
                captureViewBinding.captureButton.setImageResource(R.drawable.record_ic)
            }
            is VideoRecordEvent.Resume -> {
                captureViewBinding.captureButton.setImageResource(R.drawable.pause_ic_recording)
            }
        }
        ...
        captureLiveStatus.value = String.format("%02d:%02d", time / 60, time % 60);
